...
<html>
<head>
<title>Launch Page: Labyrinth Lord Monk Generator</title>
...
<body>
	...
	<section>
		...
		<form action="" id ="monkForm"  target="_blank" method="post">
            ...
            <span class="formIputDescription">Character Level:</span>	
			  <select id="level" name="theLevel" class="alignmentBox">	
				<option value="1" selected>1st Level, Monk</option>
				<option value="2">2nd Level, Monk</option>
				<option value="3">3rd Level, Monk</option>
				<option value="4">4th Level, Monk</option>
				<option value="5">5th Level, Monk</option>
				<option value="6">6th Level, Monk</option>
				<option value="7">7th Level, Monk</option>
				<option value="8">8th Level, Monk</option>
				<option value="9">9th Level, Monk</option>
				<option value="10">10th Level, Monk</option>
				<option value="11">11th Level, Monk</option>
				<option value="12">12th Level, Monk</option>
				<option value="13">13th Level, Monk</option>
				<option value="14">14th Level, Monk</option>
				<option value="15">15th Level, Monk</option>
				<option value="16">16th Level, Monk</option>
			  </select>
			...
			<div class="generatorButtonA2">
                ...
                <script>
                    ...
                    $("#generate_characters2").click(function(){
                        ...
                        $("#monkForm").attr('action', "character/ll_monk_"+ $("#abilityScores").val() +  ".php");
